import { CommandPermissionLevel, CustomCommandStatus, system, TicksPerSecond, world, } from '@minecraft/server';
...
const commandProcess = (origin) => {
    ...
    system.runTimeout(() => {
        form
            ...
            const remitteeIndex = (_a = response.formValues) === null || _a === void 0 ? void 0 : _a[0];
            const amountString = (_b = response.formValues) === null || _b === void 0 ? void 0 : _b[1];
            ...
            if (score < amount) {
                remitter.sendMessage(`[${(_c = origin.sourceEntity) === null || _c === void 0 ? void 0 : _c.nameTag}] ポイントが足りません。`);
                throw new PointlessError();
            }
            ScoreboardUtils.addScore(remitter, SCOREBOARD_POINT, -amount);
            if (remittee.isValid) {
                remittee.sendMessage(`${remitter.nameTag}から${amount}ポイント送られました。受け取るためには銀行の窓口までお越しください。`);
            }
