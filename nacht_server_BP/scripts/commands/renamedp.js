 ...
 */
const commandProcess = (origin, before, after) => {
...
export default () => system.beforeEvents.startup.subscribe(registerCommand(renameDynamicPropertyCommand, commandProcess));
