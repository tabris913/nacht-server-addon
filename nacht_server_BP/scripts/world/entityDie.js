...
export default () => world.afterEvents.entityDie.subscribe((event) => {
    ...
    // );
    const spawnPoint = player.getSpawnPoint() || Object.assign(Object.assign({}, world.getDefaultSpawnLocation()), { dimension: world.getDimension(MinecraftDimensionTypes.Overworld) });
    let newTag, oldTag;
